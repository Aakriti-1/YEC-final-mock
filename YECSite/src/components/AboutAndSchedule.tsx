          ...
          <div className="lg:col-span-7 flex flex-col justify-between">
            ...
            >
              <p className="font-body text-base sm:text-lg leading-relaxed text-zinc-900 font-medium">
                First established in 2008, the <strong>York Engineering Competition (YEC)</strong> is one of the largest and most important events led by the <strong>Lassonde Engineering Society</strong>. Offered annually to all our <strong>4.7k students</strong>, we strive to challenge our participants to push the boundaries of Engineering by showcasing their creativity and critical thinking in one of our seven competitions.
              </p>
                ...
                >
                  ...
                  <div className="p-5 flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <p className="font-body text-zinc-700 text-xs leading-relaxed line-clamp-4">
                        {comp.description}
                      </p>
                    </div>
